...
<a href="/pickTutor"><img src="/Element/arrow.png" class="backButton"></a>
    <div class="tutorBox">
        ...
        <div class="tutorDesc">
            <p class="desc">Name: {{ $tutor->name }}</p>
            <p class="desc">Phone Number: {{ $tutor->phone }}</p>
            <p class="desc">Email: {{ $tutor->email }}</p>
            <p class="descSubject">Subject: {{ $subject }}</p>
            <p class="desc">Fare: Rp 100.000</p>
            <div class="viewResume"><a href="{{ route('view_resumeTutor', ['name' => $tutor->name, 'subject' => $subject]) }}" style="text-decoration: none;"><p class="resumeText">View Resume</p></a></div>
        </div>
    </div>
    <div class="hireNow">
        <a href="{{ route('pick_schedule',  ['name' => $tutor->name, 'subject' => $subject]) }}" style="color: white;">
            <p>Hire Now</p>
        </a>
    </div>
